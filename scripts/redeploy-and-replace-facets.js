...
async function main() {
  ...
  const artifactIndex = buildArtifactIndex(path.resolve(__dirname, '..'));
  ...
  for (const d of deployed) {
    // Read the ABI from the Foundry artifact generated by forge build.
    const artifactPath = artifactIndex.get(d.contractId);
