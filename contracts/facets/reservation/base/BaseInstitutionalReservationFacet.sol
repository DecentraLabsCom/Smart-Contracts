...
/// @notice Reduces bytecode by eliminating wallet abstract hooks from institutional facets
abstract contract BaseInstitutionalReservationFacet is InstitutionalReservableTokenEnumerable {
    ...
    // ---------------------------------------------------------------------
    // Institutional-only abstract hooks (no wallet)
    // ---------------------------------------------------------------------
