...
abstract contract ReservableTokenEnumerable is ReservableToken {
    ...
    /// @dev Changes the status of a reservation from _PENDING to _CONFIRMED and associates it with the lab provider
    ...
    function hasActiveBookingByToken(
        ...
        // _IN_USE means access-authorized; both statuses keep the paid reservation active.
        if (
